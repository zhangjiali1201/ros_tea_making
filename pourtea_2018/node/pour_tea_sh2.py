...
class pour_tea:
	...
	if(msg.data=="start"):
	    ...
	    goal3 = MoveBaseGoal()
    	    ...
    	    goal3.target_pose.pose.position.x = 4.093163
    	    goal3.target_pose.pose.position.y = -2.575965
    	    goal3.target_pose.pose.position.z = 0
	    goal3.target_pose.pose.orientation.x = 0
	    goal3.target_pose.pose.orientation.y = 0
	    goal3.target_pose.pose.orientation.z = 0.999438
	    goal3.target_pose.pose.orientation.w = -0.033514
	...
	rospy.sleep(1)
        ...
        # Set the target pose
        pose_target = geometry_msgs.msg.Pose()
	pose_target.position.x = 0.289187336477
	pose_target.position.y = 0.0430128571969
	pose_target.position.z = 0.0609628844999

        pose_target.orientation.x=2.06030724385e-05
        pose_target.orientation.y=-4.20608467581e-05
        pose_target.orientation.z=-5.98994284133e-05
        pose_target.orientation.w=0.999999997109
